    ...
    return (
        <div className="absolute top-0 left-0 w-[302px] h-full z-20">
            ...
            <div className="absolute bottom-[240px] left-[55px] w-[200px] flex flex-col gap-6">
                ...
                {/* Social Icons */}
                <div className="flex items-center gap-6 bg-white/[0.08] backdrop-blur-md rounded-full px-7 py-3 w-fit border border-white/20 shadow-lg">
                    {/* X (Twitter) */}
                    <a href="#" className="text-white hover:text-white hover:scale-125 active:scale-90 transition-all duration-200 hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]">
